...
"""
Ejemplo para obtener las ordenes de un usuario en cierto mercado
@link http://api.surbtc.com/#mis-rdenes
...
print(Market.getPendingOrders())

# otras ordenes que se pueden buscar
#print(Market.getReceivedOrders())
#print(Market.getTradedOrders())
#print(Market.getCancelingOrders())
#print(Market.getCanceledOrders())
