...
"""
Ejemplo para obtener el historial de depósitos y retiros de cierta moneda
@link http://api.surbtc.com/#historial-de-depositos-retiros
...
Currency = Client.getCurrency('CLP')

# historial de depósitos
print(Currency.getDeposits())

# historial de retiros
print(Currency.getWithdrawals())
